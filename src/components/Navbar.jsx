  ...
  return (
    <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
      ...
      <div className="nav-actions">
        <button className="nav-btn call-btn" onClick={() => window.location.href = "tel:9634435040"}>Call</button>
        <button className="nav-btn support-btn" onClick={() => window.location.href = "/"}>Support</button>
        <button className="nav-btn chat-btn" onClick={() => window.location.href = "https://wa.me/919634435040"}>Chat</button>
